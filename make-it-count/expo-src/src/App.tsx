...
const s=StyleSheet.create({
  ...
  top:{minHeight:30,flexDirection:'row',alignItems:'center',justifyContent:'space-between'},brand:{color:colors.ink,fontSize:10.5,fontWeight:'900',letterSpacing:2.1},topRight:{color:colors.muted,fontSize:10,fontWeight:'700',letterSpacing:1.2},hero:{color:colors.ink,fontSize:42,lineHeight:44,fontWeight:'800',letterSpacing:-2,marginTop:26},roomHero:{color:colors.ink,fontSize:37,lineHeight:40,fontWeight:'800',letterSpacing:-1.7,marginTop:24},sub:{color:colors.muted,fontSize:14.5,lineHeight:22,marginTop:10,maxWidth:360},eyebrow:{color:colors.terracottaDeep,fontSize:9.5,fontWeight:'850',letterSpacing:1.25},
  field:{marginTop:27},label:{color:colors.muted,fontSize:11.5,fontWeight:'700',marginBottom:5},input:{color:colors.ink,fontSize:22,paddingVertical:11,borderBottomWidth:1,borderBottomColor:colors.line},multi:{minHeight:72,fontSize:16,lineHeight:23,textAlignVertical:'top'},durations:{flexDirection:'row',gap:7},duration:{flex:1,minWidth:0,minHeight:63,borderWidth:1,borderColor:colors.line,borderRadius:14,paddingVertical:11,paddingHorizontal:9,backgroundColor:'rgba(255,249,238,.42)'},durationOn:{backgroundColor:colors.ink,borderColor:colors.ink},durationValue:{color:colors.ink,fontSize:17,fontWeight:'850'},durationValueOn:{color:colors.white},durationDetail:{color:colors.muted,fontSize:8.5,marginTop:4},durationDetailOn:{color:'#CFC6B9'},
  previewHead:{flexDirection:'row',alignItems:'flex-end',justifyContent:'space-between',marginTop:30,marginBottom:11,gap:16},previewTitle:{color:colors.ink,fontSize:17,fontWeight:'750',marginTop:5,maxWidth:280},discovery:{color:colors.muted,fontSize:9.5,fontWeight:'700',borderWidth:1,borderColor:colors.line,borderRadius:13,paddingHorizontal:10,paddingVertical:6},slogan:{color:colors.faint,textAlign:'center',fontSize:8.5,letterSpacing:1.55,marginTop:12},
  primary:{minHeight:54,flex:1,borderRadius:16,backgroundColor:colors.ink,alignItems:'center',justifyContent:'center',paddingHorizontal:18,marginTop:18},primaryText:{color:colors.white,fontSize:15.5,fontWeight:'800'},secondary:{minHeight:54,flex:1,borderRadius:16,borderWidth:1,borderColor:colors.line,backgroundColor:'rgba(255,249,238,.5)',alignItems:'center',justifyContent:'center',paddingHorizontal:18,marginTop:18},secondaryText:{color:colors.ink,fontSize:15,fontWeight:'750'},disabled:{backgroundColor:'#D4CCBE'},pressed:{transform:[{scale:.985}],opacity:.82},
  focusHead:{flexDirection:'row',gap:12,alignItems:'flex-end',marginTop:18},focusTitle:{color:colors.ink,fontSize:20,fontWeight:'800'},focusGoal:{color:colors.muted,fontSize:11.5,lineHeight:17,marginTop:5},timer:{color:colors.ink,fontSize:36,fontWeight:'850',letterSpacing:-1.7},track:{height:4,backgroundColor:colors.line,borderRadius:3,overflow:'hidden',marginTop:15},fill:{height:'100%',backgroundColor:colors.terracotta,borderRadius:3},meta:{flexDirection:'row',justifyContent:'space-between',marginTop:8},metaText:{color:colors.muted,fontSize:9.5},actions:{flexDirection:'row',gap:9},
  context:{marginTop:30,paddingVertical:16,borderTopWidth:1,borderBottomWidth:1,borderColor:colors.line},contextLabel:{color:colors.faint,fontSize:10,fontWeight:'700'},contextTask:{color:colors.ink,fontSize:18,fontWeight:'800',marginTop:6},contextGoal:{color:colors.muted,fontSize:12,marginTop:4},resultInput:{minHeight:116,color:colors.ink,fontSize:22,fontWeight:'650',lineHeight:31,paddingVertical:12,borderBottomWidth:1,borderBottomColor:colors.ink,textAlignVertical:'top'},helper:{color:colors.faint,fontSize:10.5,lineHeight:16,marginTop:9},
  reveal:{flex:1,paddingHorizontal:22,backgroundColor:colors.paper,alignItems:'center',justifyContent:'center',overflow:'hidden'},revealBrand:{position:'absolute',left:22,top:25},seal:{alignItems:'center'},sealInner:{width:116,height:116,borderRadius:58,borderWidth:13,borderColor:'rgba(211,113,82,.14)',backgroundColor:'rgba(211,113,82,.08)'},sealCopy:{color:colors.muted,fontSize:12,marginTop:18},revealContent:{alignItems:'center',width:'100%',paddingBottom:70},rewardStage:{width:'100%',height:245,alignItems:'center',justifyContent:'center'},celebration:{position:'absolute',width:130,height:155,right:-8,bottom:4,opacity:.72},rewardName:{color:colors.ink,fontSize:36,fontWeight:'850',letterSpacing:-1.7,marginTop:7},rewardStory:{color:colors.muted,textAlign:'center',maxWidth:330,fontSize:12.5,lineHeight:20,marginTop:9},receipt:{width:'100%',marginTop:22,flexDirection:'row',gap:12,paddingVertical:14,borderTopWidth:1,borderBottomWidth:1,borderColor:colors.line},receiptMark:{color:colors.terracottaDeep,fontSize:10,fontWeight:'850',letterSpacing:1.1},receiptText:{flex:1,color:colors.ink,fontSize:14,lineHeight:20,fontWeight:'700'},roomProgress:{width:'100%',flexDirection:'row',alignItems:'center',gap:9,marginTop:14},bottom:{position:'absolute',left:22,right:22,bottom:24},
  roomScene:{marginTop:22,position:'relative'},tapHint:{position:'absolute',left:14,bottom:13,color:colors.ink,backgroundColor:'rgba(255,249,238,.88)',borderRadius:13,paddingHorizontal:10,paddingVertical:6,fontSize:9.5,fontWeight:'700'},sectionHead:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginTop:25,paddingBottom:10,borderBottomWidth:1,borderBottomColor:colors.line},sectionTitle:{color:colors.ink,fontSize:14,fontWeight:'800'},collection:{flexDirection:'row',gap:7,marginTop:11},owned:{flex:1,minHeight:100,alignItems:'center',justifyContent:'center',borderBottomWidth:2,borderBottomColor:colors.terracotta},ownedName:{color:colors.ink,fontSize:9.5,fontWeight:'700',marginTop:-5},empty:{flex:1,minHeight:100,alignItems:'center',justifyContent:'center',borderBottomWidth:1,borderBottomColor:colors.line},emptyShape:{width:38,height:49,borderRadius:11,borderWidth:1,borderStyle:'dashed',borderColor:colors.line},emptyText:{color:colors.faint,fontSize:8.5,marginTop:8},archive:{minHeight:82,flexDirection:'row',alignItems:'center',paddingVertical:14},archiveRule:{width:3,alignSelf:'stretch',backgroundColor:colors.terracotta,borderRadius:2,marginRight:12},archiveResult:{color:colors.ink,fontSize:14.5,lineHeight:20,fontWeight:'750'},archiveMeta:{color:colors.muted,fontSize:9.5,marginTop:5},arrow:{color:colors.muted,fontSize:25,fontWeight:'300',marginLeft:10},
  backdrop:{flex:1,backgroundColor:'rgba(42,40,35,.28)',justifyContent:'flex-end'},sheet:{width:'100%',maxWidth:430,alignSelf:'center',backgroundColor:colors.paper,borderTopLeftRadius:26,borderTopRightRadius:26,paddingHorizontal:22,paddingTop:10,paddingBottom:28},handle:{width:38,height:4,borderRadius:2,backgroundColor:colors.line,alignSelf:'center'},sheetTitle:{color:colors.ink,fontSize:29,fontWeight:'850',textAlign:'center',marginTop:5},sheetResult:{color:colors.ink,fontSize:15,lineHeight:22,fontWeight:'650',textAlign:'center',marginTop:10,paddingHorizontal:14},divider:{height:1,backgroundColor:colors.line,marginVertical:19},metaRow:{flexDirection:'row',justifyContent:'space-between',gap:20,paddingVertical:7},metaValue:{flex:1,color:colors.ink,fontSize:11.5,fontWeight:'700',textAlign:'right'},
});
